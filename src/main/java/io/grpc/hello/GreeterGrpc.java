...
public final class GreeterGrpc {
  ...
  public static final String SERVICE_NAME = "io.grpc.hello.Greeter";
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.hello.HelloRequest,
      io.grpc.hello.HelloReply> getSayHelloAgainMethod;
  ...
  public static io.grpc.MethodDescriptor<io.grpc.hello.HelloRequest,
      io.grpc.hello.HelloReply> getSayHelloAgainMethod() {
    io.grpc.MethodDescriptor<io.grpc.hello.HelloRequest, io.grpc.hello.HelloReply> getSayHelloAgainMethod;
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHelloAgain(io.grpc.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<io.grpc.hello.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
    ...
    /**
     */
    public io.grpc.hello.HelloReply sayHelloAgain(io.grpc.hello.HelloRequest request) {
      return blockingUnaryCall(
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.hello.HelloReply> sayHelloAgain(
        io.grpc.hello.HelloRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_SAY_HELLO_AGAIN:
          serviceImpl.sayHelloAgain((io.grpc.hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<io.grpc.hello.HelloReply>) responseObserver);
          break;
        default:
